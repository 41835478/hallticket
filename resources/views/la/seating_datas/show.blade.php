...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $seating_data->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Seating_Datas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/seating_datas/'.$seating_data->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Seating_Datas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.seating_datas.destroy', $seating_data->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/seating_datas') }}" data-toggle="tooltip" data-placement="right" title="Back to Seating Datas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'register_number')
						@la_display($module, 'block')
						@la_display($module, 'hall_number')
						@la_display($module, 'seat_number')
						@la_display($module, 'row')
						@la_display($module, 'side')
					</div>
				</div>
			</div>
		</div>
